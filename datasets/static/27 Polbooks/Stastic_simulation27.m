...
degree_hist1 = [0, 0, 1, 6, 14, 22, 11, 9, 8, 8, 2, 2, 2, 3, 1, 2, 3, 0, 3, 0, 1, 2, 1, 2, 0, 2];
degree_hist2 = [0, 5, 7, 8, 10, 20, 15, 7, 10, 4, 6, 4, 2, 2, 0, 0, 2, 1, 0, 1, 0, 0, 1];
...
title('Polbooks', 'FontSize', 13.2, 'FontWeight', 'bold')
