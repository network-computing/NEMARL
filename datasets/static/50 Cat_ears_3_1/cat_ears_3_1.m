...
degree_hist1 = [0, 17, 0, 5, 66, 28, 35, 35, 19, 5];
degree_hist2 = [0, 16, 12, 22, 58, 36, 29, 23, 13, 1];
...
% 将图例位置设置
legend('Real data', 'Model simulation', 'Location', 'northeast')
% title('Wikibooks (Initial)', 'FontSize', 13.2, 'FontWeight', 'bold')
title('cat-ears-3-1', 'FontSize', 13.2, 'FontWeight', 'bold')
