...
degree_hist1 =[0, 5, 0, 388, 498, 367, 167, 90, 55, 23, 19, 7, 4, 5, 1, 1];
degree_hist2 = [0, 0, 21, 301, 546, 443, 230, 35, 35, 12, 3, 3, 0, 1];
...
title('Bcspwr08', 'FontSize', 13.2, 'FontWeight', 'bold')
