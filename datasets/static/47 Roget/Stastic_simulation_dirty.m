...
degree_hist1 = [0, 7, 2, 2, 2, 1, 2, 4, 1, 1, 2, 1, 1, 0, 0, 1, 0, 2, 0, 0, 0, 1];
degree_hist2 = [0, 8, 3, 3, 2, 1, 4, 3, 0, 2, 1, 0, 0, 0 ,1, 0, 2, 0, 0, 0, 1];
...
title('Ragusa16', 'FontSize', 13.2, 'FontWeight', 'bold')
