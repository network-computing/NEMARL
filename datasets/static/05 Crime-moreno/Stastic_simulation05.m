...
degree_hist1 = [0, 218, 136, 177, 90, 67, 45, 23, 18, 13, 12, 10, 7, 1, 5, 0, 1, 0, 0, 2, 1, 0, 1, 0, 1, 1];
degree_hist2 = [0, 233, 181, 161, 103, 66, 32, 19, 6, 12, 3, 3, 1, 2, 1, 0, 0, 1, 2, 1, 0, 1, 0, 0, 0, 1];
...
title('Crime-moreno', 'FontSize', 13.2, 'FontWeight', 'bold')
