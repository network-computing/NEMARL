...
degree_hist1 = [0, 7, 16, 9, 11, 8, 7, 9, 6, 15, 9, 10, 6, 3, 6, 3, 5, 5, 3, 2, 1, 0, 0];
degree_hist2 = [0, 7, 13, 10, 11, 14, 11, 10, 15, 12, 5, 9, 5, 5, 6, 3, 2, 1, 0, 4, 0, 1];
...
title('Enron-only', 'FontSize', 13.2, 'FontWeight', 'bold')
